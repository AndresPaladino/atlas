...
Atlas opera en **4 modos** explícitos. Cada modo carga un protocolo distinto desde `schema/`. Este archivo es el dispatcher: define qué modo se activa, cómo se cambia, y la regla del firewall.
